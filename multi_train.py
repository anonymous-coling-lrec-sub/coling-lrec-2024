...
from multi_prompt_tuner import MultiClassTuner
...
def main(args):
    ...
    prompt_tuner = MultiClassTuner(model_name=args.model_name,
                               task=args.task,
    ...
    score_dict = prompt_tuner.train_multi_task(epochs=args.num_epochs,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--cut',
        type=int,
        help='the split between templates',
        default=0
    )
    ...
    parser.add_argument(
        '--training_mode',
        type=str,
        help = '[fine_tune,adapter,lora,last_layer,bf]',
        default='bf'
    ...
    parser.add_argument(
        '--val_task',
        type=str,
        help='select a task in cls or gen, which ever specified',
        default=''
    )
